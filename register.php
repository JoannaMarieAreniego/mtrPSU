...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="form">
            ...
            <h4>Firstname</h4>
            <input type="text" id="firstname" name="firstname" placeholder="Enter Firstname Here" onfocusout="validateUserForm();">
            <h4>Lastname</h4>
            <input type="text" id="lastname" name="lastname" placeholder="Enter Lastname Here" onfocusout="validateUserForm();">
            <h4>studID</h4>
            <input type="text" id="studID" name="studID" placeholder="Enter Student No. Here" onfocusout="validateUserForm();">
            <h4>Username</h4>
            <input type="text" id="username" name="username" placeholder="Enter Username Here" onfocusout="validateUserForm();">
            <h4>Password</h4>
                <input type="password" id="password" name="password" placeholder="Enter Password Here" required>
                <h4>Confirm Password</h4>
            <input type="password" id="confirmpass" name="confirmpass" placeholder="Confirm Password Here" onfocusout="validateUserForm();">
